...
if [[ -z "$GRAPHQL_URL" || -z "$GRAPHQL_ACCESS_TOKEN" ]]; then
  echo "Error: In order to build GraphQL types, you must provide GRAPHQL_URL and GRAPHQL_ACCESS_TOKEN env vars for the Drips GraphQL API."
